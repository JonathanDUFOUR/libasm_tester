...
fn criterion_benchmark(c: &mut Criterion) {
	...
	const S0_BUFFER_SIZE: usize = MAX_INPUT_SIZE + S0_OFFSET;
	const S1_BUFFER_SIZE: usize = MAX_INPUT_SIZE + S1_OFFSET;
	...
	let mut group: BenchmarkGroup<WallTime> = c.benchmark_group("memcmp");
